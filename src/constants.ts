...
export const TAGLINE = 'passionate about technology and art, and the sweet spot where the two collide';
export const WHO_I_AM = 'I\'m Giedrius, a resident of Amsterdam originally hailing from Vilnius. Fascinated by technology and arts, and the sweet spot where the two collide. Here I share the stories about my projects.';
