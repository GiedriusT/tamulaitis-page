...
We tried several different approaches for backrounds over which the areal combat is taking place and settled on using actual screenshots from Google Maps. Our art lead enjoyed very much "scouting for locations" that would have distinct color palletes and environments, like forests, snowy mountains, deserts and cities. At one point we even tried to contact Google to clarify licensing options for using these screenshots in our game which was a bit silly, but really demonstrates how serious we were about this game and believing that it will become a world wide success.
